...
#Version 2.1 Adds Dictionary File For Hosts

#Import Neccessary Libraries
import os, random, struct, string, time, sys, readline
...
def main():
    ...
    print("6) Generate A 24 Bit Key")
    print("7) Generate A 32 Bit Key")
    print("8) Add Key To Session")
...
def keyGenScreen(bits):
    ...
    time.sleep(0.3)
    print("Done")
    print("###DO NOT SHARE THIS KEY WITH UNTRUSTED PEOPLE###")
